  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          // DÜZELTME BURADA: bottom-24 (yukarı) ve z-[60] (en üst katman)
          className="fixed bottom-24 right-4 z-[60] rounded-full h-14 w-14 shadow-lg bg-primary hover:bg-primary/90 animate-in fade-in zoom-in duration-300"
          size="icon"
        >
          <MessageSquarePlus className="h-6 w-6 text-white" />
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-md z-[70]"> {/* Dialog da en üstte olsun */}
        <DialogHeader>
          <DialogTitle>Görüşleriniz Bizim İçin Değerli</DialogTitle>
          <DialogDescription>
            Hizmet kalitemizi artırmak için lütfen deneyiminizi puanlayın.
          </DialogDescription>
        </DialogHeader>
